export const Hero = () => {
    return (
        <div className="hero bg-darkBg px-5 py-6 flex flex-col-reverse justify-between items-center sm:flex-row sm:py-16 sm:px-10 h-full sm:h-screen pt-32 sm:pt-6">
