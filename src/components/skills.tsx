export const Skills = () => {
    return (
        <section className="skills px-5 py-6 sm:py-16 sm:px-10 bg-darkBg" id="skills">
            ...
            {/* Heading */}
            <div className="heading text-2xl text-white font-semibold">Moje umiejętności</div>
                    ...
                    <div className="cols flex flex-row gap-36">
                        <div className="left flex flex-col gap-7">
                            ...
                            <div className="col">
                                ...
                                <div className="level text-text font-regular text-lg -mt-1">Początkujący</div>
                            </div>
                        </div>
                        ...
                        <div className="right flex flex-col gap-7">
                            ...
                            <div className="col">
                                ...
                                <div className="level text-text font-regular text-lg -mt-1">Początkujacy</div>
                            </div>
                            <div className="col">
                                <div className="title flex gap-3 items-center">
                                    <i className="fa-regular fa-square-check text-xl text-primary"></i>
